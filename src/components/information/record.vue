    ...
    <div class="riskIndex">
        <div class="buttoncrowd top_header">
            <div style="float:left;">
                <span class="risktitle">资质档案  </span>
            </div>
            ...
            <el-table :data="tableData" :span-method="arraySpanMethod"  border stripe style="width: 100%;">
                ...
                <el-table-column align="center" prop="handle" label="操作">
                    <template slot-scope="scope">
                        <el-button @click="detailRoute(scope.row.id)" type="primary" size="mini" >编辑</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
export default {
    ...
    methods:{
        arraySpanMethod(){},
        goAdd(){
            this.$router.push({path:'/home/information/recordAdd',name:'recordAdd'})
        },
        exportData(){//导出数据
        ...
        detailRoute(id){//编辑页面跳转
            this.$router.push({path:'/home/information/recordEdit',name:'recordEdit'})
