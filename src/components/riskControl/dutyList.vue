<template>
    <div class="riskIndex">
        <div class="buttoncrowd">
            <div>
                <span class="risktitle" >责任清单</span>
            </div>
        ...
        <div class="buttoncrowd">
            ...
            <el-table-column type="selection"  width="35"> </el-table-column>
                ...
                <el-table-column align="center" prop="createTimeFormat" label="现有风险等级" >
                    <template slot-scope="scope">
                        <el-popover
                            placement="right"
                            width="400"
                 ...
                 <el-table-column align="center" prop="statusName" label="管控层级" >
                    <template slot-scope="scope">
                ...
                <el-table-column align="center" prop="purchaseOrder" label="责任部门" >
                    <template slot-scope="scope"><span>{{scope.row.purchaseOrder }}</span></template>
                </el-table-column>
                <el-table-column align="right" prop="amount"  label="责任人" >
                    <template slot-scope="scope"><span>{{scope.row.amount }}</span></template>
                </el-table-column>
